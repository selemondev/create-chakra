      ...
      <CBox w="100%" p="5">
        <CFlex align="center" justify="center" mt="2">
          ...
          <CLink href="https://vuejs.org/">
            <chakra.img w="100px" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Vue.js_Logo_2.svg/1024px-Vue.js_Logo_2.svg.png?20170919082558" />
          </CLink>
        </CFlex>
        <CBox>
          <CText align="center" mt="10" font-weight="bold"  :font-size="{ base: '24px', md: '40px'}">Chakra UI + Vue 3 + TypeScript</CText>
          <CText align="center" mt="2" :font-size="{ base: '16px', md: '24px' }" font-weight="extra-bold">This project is scaffolded using
            create-chakra@latest</CText>
          <CText align="center" mt="2" :font-size="{ base: '18px', md: '24px'}" font-weight="bold">Please leave a star if you like it.</CText>
        </CBox>
